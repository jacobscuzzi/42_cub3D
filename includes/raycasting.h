...
/*   Updated: 2025/03/24 18:02:55 by varodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				init_ray_casting(t_data *data, float *first_ray,
						float *raysfield, int *slice_width);
float				fix_fisheye(float distance, float gamer_dir,
						float ray_angle);
void				load_texture(t_data *data, t_texture *texture, char *path);
void				draw_wall_slice(t_data *data, int r, float disT,
						int slice_width, int tex_x);
float				check_horizontal_lines(t_data *data, float first_ray,
						float *hx, float *hy);
float				check_vertical_lines(t_data *data, float first_ray,
						float *vx, float *vy);
